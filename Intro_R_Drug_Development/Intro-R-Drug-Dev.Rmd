---
title: "Intro to Shiny, R Markdown & DBs - Application in Research & Drug Development PharmaSUG 2018"
author: "Phil Bowsher"
date: "Sun, April 29th, 2018"
output: 
...
## Workshop Goals - Workshop has 7 Parts

### Part 1-7 - You will learn:
- Setup
...
- New DB Landscape
- APIs
- Live Drug Development Examples
...
- Explore ToothGrowth
- Rpubs
- Toothgrowth_Notebook.Rmd in Handout folder has examples but try to find your own
...
## Review Handout
- Panels
- 1_Shiny_ToothGrowth_HelloWorld
...
## Your Turn Shiny Development Example - 1_Shiny_ToothGrowth_Basic

- Go [here](http://shiny.rstudio.com/gallery/basic-datatable.html)
- Create a new multi file shiny app in the IDE by going to 'File' and select 'New File' and select 'Shiny Web App...' and create a new multiple file app and title it 'pharmasugshiny'
...
## So, Which is better OJ or VC?
- Let's explore ToothGrowth with some Interactive visualizations
